...
Right now, it has the following capabilities (as of 1.x):
- Importing Artitas projects up to (and presumably exceeding) the size of the base game (tested in 7.26.1)
