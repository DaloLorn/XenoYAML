export default function isArtitasTemplate(parsedJson) {
  if (
    !!parsedJson.version &&
    !!parsedJson.asset?.Name &&
    (parsedJson.asset.$t == "4" ||
      parsedJson.asset.$type == "Artitas.Template") &&
    (parsedJson.$t == "15" ||
      parsedJson.$type == "Common.Content.DataStructures.VersionedAsset") &&
    (!parsedJson.asset.Parent ||
      parsedJson.asset.Parent.$t == "ar_Template" ||
      parsedJson.asset.Parent.$type ==
